export default {
  COMMON: {
    ADDRESS: 'Address',
    ALL: 'All',
    APP_NAME: 'RIPAEX Desktop Wallet',
    APP_NAME_SHORT: 'RIPAEX Desktop',
  ...
  INTRODUCTION: {
    ...
    DUTY: {
      ...
      WARNING: {
        ...
        CANNOT_RESTORE: 'lost passwords, passphrases or stolen funds cannot be restored by the delegates, RIPAEX.io team, or anyone else'
      },
    ...
    RESPONSIBILITY: {
      ...
      STORAGE: {
        EXPLANATION: 'The {PASSPHRASE} of each wallet address is able to sign transactions and move funds. This means if your computer dies but you have your passphrase, you can still access your funds. The RIPAEX Desktop Wallet has an additional feature that lets you set an {ENCRYPTED} as well, for easier management. If your computer dies, you cannot use the encrypted password to access your funds from a different machine. {NEED}.',
      ...
      BACKUP: {
        ...
        OPTIONS: 'You can write it down on thick paper and store multiple copies in secure locations. You can also store it on an encrypted flash drive. Alternatively, you can use a Ledger Nano S USB hardware device, available at Ledger.com, to store and access your funds and the RIPAEX Desktop Wallet. You can plug your Ledger Nano S into your computer and access the RIPAEX blockchain without needing to enter your passphrase.'
      },
    ...
    TURN: {
      TITLE: 'Your Turn',
      KNOWLEDGE: 'Now, armed with the knowledge of how important it is to keep your passphrases safe, you are ready to claim your financial autonomy with the RIPAEX Desktop Wallet.',
      SUPPORT: 'RIPAEX is an open-source ecosystem and if you need assistance, the RIPAEX community and team is here to help. Create a post on reddit.ark.io, or join the real-time chat system at slack.ark.io.',
      CONCLUSION: 'Everyone here on the RIPAEX.io team hopes you enjoy using the RIPAEX Desktop Wallet to participate in the blockchain revolution!'
    }
  },
  ...
  PAGES: {
    ...
    WALLET_EXCHANGE: {
      CHANGELLY_TERMS: {
        TITLE: 'Purchase {ticker} directly within RIPAEX Desktop Wallet with our Changelly integration',
  ...
  WALLET_DELEGATES: {
    ...
    BLOG: 'Voting Guide',
    EXPLANATION: 'Voting is an optional, but important mechanism that keeps the RipaEX network secure. The 101 delegates with the most votes from the network are responsible for verifying and forging transactions into new blocks. This page can be used to cast your vote for a delegate that you support. Learn more about voting for a delegate by clicking on the following link:',
